...
const SEV_COLOR: Record<string, string> = { ERROR: "#C0392B", FATAL: "#7B241C", WARN: "#B6862C", WARNING: "#B6862C", INFO: "#3D3D3D", DEBUG: "#2980B9", UNSPECIFIED: "#9aa0a6" };
    ...
    series: [
      {
        ...
        data: Object.entries(counts).map(([k, v]) => ({
          name: k,
          value: v,
          itemStyle: { color: SEV_COLOR[k] || "#888" },
        })),
      },
    ],
  };
