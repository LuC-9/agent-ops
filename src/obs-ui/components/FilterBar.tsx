...
const RANGES = [
  ...
  { value: "1d", label: "Last 1 day" }, { value: "3d", label: "Last 3 days" },
  { value: "5d", label: "Last 5 days" }, { value: "7d", label: "Last 7 days" },
  { value: "15d", label: "Last 15 days" }, { value: "1mo", label: "Last 1 month" },
  ...
  return (
    <Card size="small" style={{ marginBottom: 12 }} styles={{ body: { padding: 12 } }}>
      <Space wrap size="middle">
        ...
        <Select mode="multiple" allowClear placeholder="Platform" style={{ minWidth: 220, maxWidth: 360 }}
